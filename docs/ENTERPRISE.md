...
**Caveat:** end-to-end cost reduction is typically ~1.6–3×, not the 12-50× retrieval-stage figure. Plan budget conversations against the realistic number. See [HONEST-ASSESSMENT.md](HONEST-ASSESSMENT.md#what-12-50×-reduction-actually-means).
